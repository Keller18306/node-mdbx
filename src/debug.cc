...
void MDBX_Native_Debug::Init(Napi::Env env, Napi::Object exports) { exports.Set("setup_debug", Napi::Function::New<MDBX_Native_Debug::Setup>(env)); }
...
void MDBX_Native_Debug::Logger(MDBX_log_level_t loglevel, const char *function, int line, const char *fmt, va_list args) noexcept {
	char message[1024];
